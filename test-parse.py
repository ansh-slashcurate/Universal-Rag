...
import re
from parser.liteparser.liteparser import dockling_parser

# document = dockling_parser(r"C:\Users\vijaya kumar pappuri\Downloads\parsing-testing1.pdf")
# print("keys", list(dockling_parser.keys()))
# print(dir(document))
...
# )
# print(f"Loaded in {time.time()-start:.1f}s — should be a few seconds, zero downloads")